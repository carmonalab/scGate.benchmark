...
testing.datasets <- readRDS("~/Dropbox/CSI/Datasets/human/human.sets.expanded.singler.rds")  ### NB: put these models online (switchdrive?)

```

Load default models from DB
```{r}
models.DB <- scGate::get_scGateDB(force_update = T)   ### NB: WE MUST SPECIFY A TAG HERE, TO KEEP THE BENCHMARK REPRODUCIBLE - NOT FORCE UPDATE
models <- models.DB$human$generic
print(models%>%names)
