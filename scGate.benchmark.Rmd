...
#levs <- c("Bcell","PanBcell","MoMacDC","Myeloid","NK","Tcell","CD4T","CD8T")
...
ggsave(file.path(figure.path,"benchmark_20012022_scGate_portr.pdf"), plot=b, width=7, height=4)
ggsave(file.path(figure.path,"benchmark_20012022_scGate_portr.wide.pdf"), plot=b, width=9, height=4)
