...
testing.datasets <- testing.datasets[c("Jerby","PBMC_Satija","Yost","zilionis")]
...
Try alternative way of showing these plots
```{r}
...
ggsave(file.path(figure.path,"benchmark_02112021_scGate_lands.pdf"), plot=a, width=9, height=4)
...
ggsave(file.path(figure.path,"benchmark_02112021_scGate_portr.pdf"), plot=b, width=6, height=4)
