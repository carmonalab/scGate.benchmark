...
```{r}
colors <- c("#E69F00", "#56B4E9","#56E9BA","#E06D55","#E0D855")
...
ggsave(file.path(figure.path,"benchmark_19012022_scGate_lands.pdf"), plot=a, width=9, height=4)
...
ggsave(file.path(figure.path,"benchmark_19012022_scGate_portr.pdf"), plot=b, width=6, height=4)
